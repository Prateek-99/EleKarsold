...
const EnquiryForm = () => {
  ...
  return (
    <div className="flex flex-col-reverse md:flex-row bg-white rounded-lg shadow-lg md:px-4">
      {/* USP Section */}
      <div className="md:w-1/2 p-2 md:p-4 bg-blue-50 rounded-l-lg">
        ...
        <ul className="flex justify-center flex-col text-center gap-4 pl-5 space-y-2">
          ...
          <li className="flex flex-col font-medium text-[#22448b] text-start">
            ...
            Our highly trained, professional drivers ensure a safe and smooth
            ride every time.
          </li>
          <li className="flex flex-col font-medium text-[#22448b] text-start">
            <p className="text-[#33ae60]">
          ...
          <li className="flex flex-col font-medium text-[#22448b] text-start">
            ...
            Your safety is our priority—every vehicle is equipped with 6
            advanced airbags for maximum protection.
          </li>
          <li className="flex flex-col font-medium text-[#22448b] text-start">
            <p className="text-[#33ae60]">
              <i className="fas fa-car-side mr-2"></i>
      ...
      {/* Form Section */}
      <div className="md:w-1/2 p-4 bg-white px-12 rounded-r-lg">
